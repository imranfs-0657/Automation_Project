...
def main():
    st.title("Streamlit UI for Running a Script")

    # Define default values
    FOLDER_NAME = "Comcast_Data"

    FOLDER_DEST = r"C:\Users\imran.s\Desktop\POC Disney\Thinkcell_Automation\storage"
...
def update_charts():
    ...
    print("")
    print("All Charts has been updated successfully.")
